...
class MaterialsDatabase:
    ...
    def save(self):
        ...
        try:
            # Convert materials to ensure JSON serialization works
            serializable_materials = self._make_json_serializable(self.materials)
            
            with open(self.data_file, 'w') as f:
                json.dump(serializable_materials, f, indent=2)
        except (IOError, OSError, PermissionError):
            # Handle read-only filesystems (e.g., Streamlit Cloud)
            pass
